...
export default function Home() {
  return (
    <div>
      <Head>
        <title>CU-traders.com- Lets start trading today!</title>
        <meta name="description" content="Cu-traders.com -Lets start the trading today" />
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-wrap w-full mb-20 flex-col items-center text-center">
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-2 text-gray-900">Sell or Buy anything with CU Traders.com</h1>
      <p className="lg:w-1/2 w-full leading-relaxed text-gray-500">Wanna Buy something? For whom are your waiting for. Go for it . Buy and resell instantly now at CU Traders app. Go checkout latest offers!! Your own <strong>Chandigarh University's trading app is here</strong>. Use it now!</p>
    </div>
