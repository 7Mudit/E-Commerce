...
let products=await Product.find({"category": { "$in": ["T-shirts"]}})
let nivia={}
for(let item of products){
  ...
  return{
    props:{products:JSON.parse(JSON.stringify(nivia))}// will be passed to page components  as props
  }
}


export default Nivia;
